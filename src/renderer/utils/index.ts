...
export function checkSecondsField(secondsField) {
  return checkField(secondsField, 0, 59)
}

export function checkField(secondsField, minimal, maximal) {
...
export function checkIntValue(value, minimal, maximal, checkExtremity = false) {
  try {
...
export function checkMinutesField(minutesField) {
  return checkField(minutesField, 0, 59)
}

export function checkHoursField(hoursField) {
  return checkField(hoursField, 0, 23)
}

export function checkDayOfMonthField(dayOfMonthField) {
  if (dayOfMonthField == '?') {
    return true
  }
...
export function checkMonthsField(monthsField) {
...
export function checkDayOfWeekField(dayOfWeekField) {
...
export function checkYearField(yearField) {
  return checkField(yearField, 1970, 2099)
}

export function checkFieldWithLetter(
  value,
  letter,
  minimalBefore,
  maximalBefore,
...
export function checkIncrementField(value, minimal, maximal) {
